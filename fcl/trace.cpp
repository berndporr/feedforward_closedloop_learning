...
void FCLTrace::setParameters (double f, double q)
{
...
void FCLTrace::impulse (const char *name)
{
    int steps = 100;
#ifdef DEBUG_BP
...
double FCLTrace::filter (double value)
{
    double input = 0.0;
    double output = 0.0;
...
void FCLTrace::calcNorm (double f)
{
    double max = 0;
    norm = 1;
    for (int i = 0; i < (2 / f); i++)
...
void FCLTrace::calcPolesZeros (double f, double r)
{
